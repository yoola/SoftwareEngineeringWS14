# CPP files
CPPFILES := converter.cpp dollartoeuroconverter.cpp TemperatureConverter.cpp ShoeSizeConverter.cpp CompositeConverter.cpp InverseConverter.cpp Command.cpp
